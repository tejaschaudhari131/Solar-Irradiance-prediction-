...
doc = Document()
doc.add_heading('Solar Radiation Prediction Results - NGBoost Classifier', 0)
...
# Define the NGBoost Classifier model
ngb = NGBClassifier(Dist=Bernoulli, Score=LogScore, random_state=101)
...
# Cross-validation
cv_results = cross_val_score(ngb, X, y, cv=10, scoring='accuracy')
...
# Save the document
doc.save('NGBoost_Classifier_Results.docx')
