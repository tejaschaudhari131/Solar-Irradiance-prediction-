...
doc = Document()
doc.add_heading('Solar Radiation Prediction Results - LGBM Classifier', 0)
...
# Define the LGBM Classifier model
lgbm_model = LGBMClassifier(objective='binary', random_state=101)
...
# Save the document
doc.save('Solar_Radiation_Prediction_LGBM_Classifier_Results.docx')
