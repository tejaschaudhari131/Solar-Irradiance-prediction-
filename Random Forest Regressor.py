...
doc = Document()
doc.add_heading('Solar Radiation Prediction Results - Random Forest Regressor', 0)
...
# Cross-validation
cv_results = cross_val_score(rf_model, X, y, cv=10, scoring='neg_mean_squared_error')
...
# Save the document
doc.save('Solar_Radiation_Prediction_RandomForest_Regressor_Results.docx')