...
doc = Document()
doc.add_heading('Solar Radiation Prediction Results - CatBoost Classifier', 0)
...
catboost_model = CatBoostClassifier(random_state=101, verbose=0)
...
# Cross-validation
cv_results = cross_val_score(catboost_model, X, y, cv=10, scoring='accuracy')
...
# Save the document
doc.save('CatBoost_Classifier_Results.docx')