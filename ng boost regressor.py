...
doc = Document()
doc.add_heading('Solar Radiation Prediction Results - NGBoost Regressor', 0)
...
# Define the NGBoost Regressor model
ngb = NGBRegressor(Dist=Normal, Score=LogScore, random_state=101)
...
# Cross-validation
cv_results = cross_val_score(ngb, X, y, cv=10, scoring='neg_mean_squared_error')
...
# Save the document
doc.save('NGBoost_Regressor_Results.docx')
