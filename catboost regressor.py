...
doc = Document()
doc.add_heading('Solar Radiation Prediction Results - CatBoost Regressor', 0)
...
catboost_model = CatBoostRegressor(iterations=1000, learning_rate=0.1, depth=6, random_state=101)
...
# Cross-validation
cv_results = cross_val_score(catboost_model, X, y, cv=10, scoring='neg_mean_squared_error')
...
# Save the document
doc.save('Solar_Radiation_Prediction_CatBoost_Regressor_Results.docx')