...
doc = Document()
doc.add_heading('Solar Radiation Prediction Results - LGBM Regressor', 0)
...
lgbm_model = LGBMRegressor(objective='regression', random_state=101)
...
# Cross-validation
cv_results = cross_val_score(lgbm_model, X, y, cv=10, scoring='neg_mean_squared_error')
...
# Save the document
doc.save('Solar_Radiation_Prediction_LGBM_Regressor_Results.docx')
