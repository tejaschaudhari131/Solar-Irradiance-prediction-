...
doc = Document()
doc.add_heading('Solar Radiation Prediction Results - Random Forest Classifier', 0)
...
# Cross-validation
cv_results = cross_val_score(rf_model, X, y, cv=10, scoring='accuracy')
...
# Save the document
doc.save('RandomForest_Classifier_Results.docx')