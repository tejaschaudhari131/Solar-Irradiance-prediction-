...
doc = Document()
doc.add_heading('Solar Radiation Prediction Results - XGBoost Regressor', 0)
...
xgb_regressor = XGBRegressor(objective='reg:squarederror', random_state=101)
...
# Cross-validation
cv_results = cross_val_score(xgb_regressor, X, y, cv=10, scoring='neg_mean_squared_error')
...
# Save the document
doc.save('Solar_Radiation_Prediction_XGBoost_Regressor_Results.docx')
