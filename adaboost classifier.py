...
doc = Document()
doc.add_heading('Solar Radiation Prediction Results - AdaBoost Classifier', 0)
...
# Define the AdaBoost Classifier model with a DecisionTreeClassifier as the base estimator
...
# Cross-validation
cv_results = cross_val_score(adaboost_model, X, y, cv=10, scoring='accuracy')
...
# Plot true vs predicted values (as a scatter plot of class labels)
...
# Plot residuals (as differences between true and predicted class labels)
...
# Save the document
doc.save('Solar_Radiation_Prediction_AdaBoost_Classifier_Results.docx')
